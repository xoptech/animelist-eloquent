...
![One to One](docs/one-to-one.png)
...
`$user->profile`
![user->profile](docs/ss1.png)

`$user->profile->user` (inverse)
![user->profile->user](docs/ss2.png)
...
`$user->review()->get()`
![user->review()->get()](docs/ss3.png)

`$anime->review()->get()`
![anime->review()->get()](docs/ss4.png)

`$review->user` (inverse)
![review->user](docs/ss5.png)

`$review->anime` (inverse)
![review->anime](docs/ss6.png)
...
`$user->favorite()->get()`
![user->favorite()->get()](docs/ss7.png)

`$anime->favorite()->get()`
![anime->favorite()->get()](docs/ss8.png)

`$favorite->user` (inverse)
![favorite->user](docs/ss9.png)

`$favorite->anime` (inverse)
![favorite->anime](docs/ss10.png)
...
`$user->rating()->get()`
![user->rating()->get()](docs/ss11.png)

`$anime->rating()->get()`
![anime->rating()->get()](docs/ss12.png)

`$rating->user` (inverse)
![rating->user](docs/ss13.png)

`$rating->anime` (inverse)
![rating->anime](docs/ss14.png)
...
`$anime->animeStudio()->get()`
![anime->animeStudio()->get()](docs/ss15.png)

`$studio->animeStudio()->get()`
![studio->animeStudio()->get()](docs/ss16.png)

`$anime->animeStudio()->first()->studio` (inverse)
![anime->animeStudio()->first()->studio](docs/ss17.png)

`$studio->animeStudio()->first()->anime` (inverse)
![studio->animeStudio()->first()->anime](docs/ss18.png)
